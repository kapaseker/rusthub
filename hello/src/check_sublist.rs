...
mod test {
    use crate::check_sublist::{Comparison, sublist};
    ...
    #[test]
    fn case_3() {
        assert_eq!(Comparison::Superlist, sublist(&[1, 2, 3], &[1]));
    }

    #[test]
    fn case_4() {
        assert_eq!(Comparison::Sublist, sublist::<i32>(&[1, ], &[2, 3, 4, 5, 1]));
    }

    #[test]
    fn case_5() {
        assert_eq!(Comparison::Unequal, sublist::<i32>(&[9, 10], &[2, 3, 4, 5, 1]));
    }
